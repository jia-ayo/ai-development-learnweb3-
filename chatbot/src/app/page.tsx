...
export default function Home() {
 ...
 const Submit = (event: React.KeyboardEvent<HTMLTextAreaElement>) => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between px-4 py-2 md:px-8 md:py-3 lg:px-16 lg:py-4 xl:px-24 xl:py-5">
      <h1 className="text-xl md:text-2xl lg:text-4xl xl:text-5xl font-sans">Chat Bot</h1>

      <div className="flex w-[29rem] h-[30rem] md:w-[30rem] md:h-[45rem] lg:h-[35rem]  lg:w-[40rem] flex-col items-center bg-gray-600 rounded-xl">
        ...
        <div className="relative  w-[80%] bottom-4 flex justify-center">
          ...
          <button
            ...
            className="w-[25%] md:w-15% bg-blue-500 px-4 py-2 rounded-r"
          >
            send
          </button>
        </div>
