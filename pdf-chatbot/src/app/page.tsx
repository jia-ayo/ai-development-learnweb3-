  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-8 sm:p-24">
      <div
        {...getRootProps({
          className:
            "dropzone bg-gray-900 text-center border border-gray-800 p-4 sm:p-10 rounded-md hover:bg-gray-800 transition-colors duration-200 ease-in-out cursor-pointer",
        })}
      >
        <input {...getInputProps()} />
